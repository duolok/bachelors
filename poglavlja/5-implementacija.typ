...
Линукс `/proc` фајл систем пружа текстуални интерфејс ка kernel подацима. Иако изгледају као обични фајлови,
...
Главна метода за слање сигнала користи `kill` команду преко Tokio Command API-ја. Овај приступ 
