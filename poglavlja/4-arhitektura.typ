...
прикупљачу и складишти резултате. Користи `broadcast` канал из Tokio библиотеке за дистрибуцију метрика.
...
Flux је образац креиран од стране Facebook-а за развој корисничких интерфејса. 
...
За синхронизацију се користе Tokio примитиви @tokio-tutorial:
...
Раст-ов систем власништва и позајмљивања @rust-book гарантује да не може доћи до трке до података, што чини конкурентни код 
